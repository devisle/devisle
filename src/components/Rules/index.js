...
const Rules = () => (
  <>
    ...
    <div className={styles.Rules}>
      ...
      <p>d) Be friendly and professional. Don’t make people feel stupid for asking
      a question or belittle their choices or opinions. </p>
      ...
      <p>a) Be consistently among the most helpful members of the
      server for an extended period of time. We don’t collect metrics on this,
      but it should be obvious to any active member who deserves this
      recognition. </p>
      <p>b) Be humble. </p>
      ...
      <p>b) If a question is better suited for a different channel (or server!), direct them where to take it. </p>
      <p>c) If a question has gone unacknowledged, ask for more information. </p>
      <p>d) Refocus conversations when they get off track. </p>
      
      <h3>3. Admins all of the above, and: </h3>
      <p>a) Handle spammers. </p>
      <p>b) Take an active role in fostering a welcoming
      and positive environment. </p>
      ...
      <p>d) First give a single warning, then failing that, ban any persons who break the rules immediately</p>
    </div>
    <Footer />
  </>
);
